...
import com.khabaznia.bots.core.meta.response.dto.Media
import com.khabaznia.bots.core.meta.response.impl.*
...
class ResponseMapper {
    ...
    static MessageResponse toResponse(Message result) {
        new MessageResponse(result: new com.khabaznia.bots.core.meta.response.dto.Message(
    ...
    static ChatResponse toResponse(Chat chat) {
        new ChatResponse(chat: new com.khabaznia.bots.core.meta.response.dto.Chat(
                id: chat.id,
                type: chat.type,
    ...
    static ChatMemberResponse toResponse(ChatMember chatMember) {
        new ChatMemberResponse(chatMember: new com.khabaznia.bots.core.meta.response.dto.ChatMember(
