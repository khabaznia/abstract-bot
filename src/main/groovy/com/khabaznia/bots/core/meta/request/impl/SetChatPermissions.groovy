...
import com.khabaznia.bots.core.meta.object.ChatPermissions
...
@Component(value = 'setChatPermissions')
@Scope('prototype')
@Builder(builderStrategy = SimpleStrategy, prefix = '')
@TupleConstructor(includeSuperFields = true)
class SetChatPermissions extends BaseRequest<BooleanResponse> {
