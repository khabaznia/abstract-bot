package com.khabaznia.bots.example
...
final class Constants {
    ...
    public static final String MY_MEETINGS = '/myMeetingsMenu'
    public static final String EDIT_MY_DISCUSS_POINTS = '/myDiscussPoints'
}
